 ...
 * <p>
 * This class provides methods to encrypt and decrypt data using AES algorithm with a given key.
 * It supports encryption and decryption using byte arrays, base64 encoded keys, and SecretKey objects.
 * </p>
 */
public class AESTools {
    ...
    public static byte[] decryptToByteFromBase64(String data,@NotNull SecretKey originalKey) throws IllegalBlockSizeException {
        try {
            Cipher cipher = Cipher.getInstance("AES");
            cipher.init(Cipher.DECRYPT_MODE, originalKey);
            byte[] decoded_data = cipher.doFinal(Base64.getDecoder()
                    .decode(data));
            return decoded_data;
